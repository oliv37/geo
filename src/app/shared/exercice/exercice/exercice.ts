...
import { ExerciceLevel1 } from '../exercice-level/exercice-level-1/exercice-level-1';
import { ExerciceLevel2 } from '../exercice-level/exercice-level-2/exercice-level-2';
import { ExerciceLevel3 } from '../exercice-level/exercice-level-3/exercice-level-3';
import { ExerciceLevel } from '@shared/exercice/exercice-level';

@Component({
  selector: 'geo-exercice',
